...
if True:
    ...
    mf_model = MultiFidelityEGO(setup, proposed = True, optim_var = False, initial_nr_samples = 3, max_cost = np.inf, MFK_kwargs = MFK_kwargs)
    ...
    pp.fig.suptitle(pp.figure_title + ": No weighing", x = 0.625, y = 0.95)
    pp.draw_current_levels(mf_model)

    print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
    print("~~~~~~~~~~~~~~~ Distance Non-linear ~~~~~~~~~~~~~~~~")
    print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
    ...
    print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
    print("~~~~~~~~~ Distance + Variance Non-linear ~~~~~~~~~~~")
    print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
    ...
    mf_model.variance_weighing = True
    mf_model.distance_weighing = True
    mf_model.sample_nested(2,np.array([[0.7825]]))
    mf_model.weighted_prediction()
    mf_model.create_update_K_pred()
    pp.fig.suptitle(pp.figure_title + ": Distance + Variance weighing", x = 0.625, y = 0.95)
    pp.draw_current_levels(mf_model)
